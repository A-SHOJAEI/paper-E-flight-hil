...
% Venue-neutral draft (article). Target venue is IEEE Aerospace Conference 2027 (Big Sky;
% abstract due 2026-07-01, paper due 2026-10-03, VERIFIED on aeroconf.org).
% Reformat to the IEEE conference template for submission.
% Numbers from committed evidence: pi_a53_gate.json (real Pi 5),
% closed_loop_integration.json (live shield), and the air-bearing protocol/sim.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\title{\textbf{Flight-Class Processor-in-the-Loop Validation of a\\
Reliability-Asymmetric Spacecraft GNC Stack}}
...
\input{tables/tab_flightclass.tex}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\linewidth]{figs/fig_hifi.pdf}
